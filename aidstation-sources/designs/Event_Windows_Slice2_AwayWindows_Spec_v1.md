...
**Status:** **DESIGN-FIRST — decisions made, awaiting a final nod on the counts seam (§4.1) before build.** Trips **Trigger #1** (away-overlay wording — **APPROVED** §7) + **Trigger #3** (one `away_locale` ALTER).
