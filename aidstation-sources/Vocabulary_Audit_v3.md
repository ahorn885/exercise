# Vocabulary Self-Pass — v3

**Built:** May 2026 (v3 amendment: 2026-05-12, FC-2)
**Supersedes:** `Vocabulary_Audit_v2.md`
**Resolves:** D-39 (Collarbone added to canonical body parts; total recount). Closes Onboarding handoff Open Items #1 (equipment vocab) and #2 (body part vocab).
**Sources reconciled:** `AR_Athlete_Onboarding_Schema.md` Section 2.2 · `AR_Exercise_Database_v17.xlsx` cols 7, 11, 13 · `D23_Curation_Reference_v1.md` (FC-1b, Collarbone amendment)
**Status:** Canonical lists locked. Layer 0 cleanup actions and v2 spec changes flagged. Body part canonical list now 51 tokens.

---

## What changed in v3 vs v2

1. **`Collarbone` added to Section 1 canonical body parts** (Shoulder region). Source: D-23 curation (`D23_Curation_Reference_v1.md`, 2026-05-12). Drove D-006 (Mountain Biking) mapping for clavicle fractures from crashes. Anatomically the clavicle sits between sternum and shoulder; clinically named "collarbone" in athlete-facing context. Other plausible surfacings in future curation: paddle sports (clavicle stress from heavy paddling — uncommon), strength training (overhead loading falls).
2. **Section 1 total recount: 41 → 51.** The v2 header "Total: 41 canonical body parts" was stale; enumerated tables summed to 50 in v2 (50 + Collarbone = 51 in v3). Recount confirmed against per-subsection tables.
3. **No other section changes.** Sections 2–8 carry forward from v2 unchanged.
...
| Collarbone | D-23 (FC-1b, 2026-05-12) | Clavicle — added for D-006 (Mountain Biking) crash injury patterns. Common clinical/athlete-facing term retained over "clavicle" |
...
**Total:** 51 canonical body parts.

*Per-subsection breakdown (v3):* Head/Neck 3 · Shoulder 5 (+1 v3: Collarbone) · Arm 11 · Back 5 · Hip 6 · Upper leg 3 · Knee 7 · Lower leg 5 · Foot/Ankle 4 · Trunk 2 = **51 total**.
