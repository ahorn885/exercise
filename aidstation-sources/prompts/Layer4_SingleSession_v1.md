...
```json
{
  ...
  "description": "Record the synthesized ad-hoc workout matching the athlete's D-63 request.",
  "input_schema": {
    "type": "object",
      ...
      "session": {
        ...
        "properties": {
          ...
          "coaching_flags": {
            ...
            "items": {
              "type": "string",
              "enum": ["intensity_modulated", "technique_emphasis", "discipline_specific_intensity"]
            },
            "maxItems": 3,
            "uniqueItems": true
          },
