...
**DECIDED (Andy, 2026-06-16): ALL 4 are full prescribable 0B entries** — each added to `layer0.exercises` AND `layer0.sport_exercise_map` (so the synthesizer can program them), with full 0B fields (movement_patterns, primary/secondary muscles, equipment_required, exercise_type, coaching_cues; progression/regression links optional). Not identity-only.
