# Athlete Data Integration Spec — v5

**Version:** 5.0
**Status:** Draft v5. Cross-cutting spec — not a Layer N spec; follows its own structure rather than the 14-section node-spec depth standard (Control_Spec §8.3, post-v6 amendment).
**Last updated:** 2026-05-16 (v5: §2.5 SQLite freeze retired by definition — PR13 (`5776cef`) stripped the SQLite path entirely. §2.5 body retained as historical context but flagged Retired.)
**Supersedes:** `Athlete_Data_Integration_Spec_v4.md` (2026-05-14)
**Source decisions:**
