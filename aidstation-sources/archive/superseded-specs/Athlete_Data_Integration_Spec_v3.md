# Athlete Data Integration Spec — v3

**Version:** 3.0
**Status:** Draft v3. Cross-cutting spec — not a Layer N spec; follows its own structure rather than the 14-section node-spec depth standard (Control_Spec §8.3, post-v6 amendment).
**Last updated:** 2026-05-14 (v3: single-repo reconciliation — cross-refs corrected; Garmin pause noted per closed API access; v1+v2 selective-rebuild framing acknowledged)
**Supersedes:** `Athlete_Data_Integration_Spec_v2.md` (2026-05-13)
**Source decisions:**
