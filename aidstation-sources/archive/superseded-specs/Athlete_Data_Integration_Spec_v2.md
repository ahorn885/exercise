# Athlete Data Integration Spec — v2

**Version:** 2.0
**Status:** Draft v2. Cross-cutting spec — not a Layer N spec; follows its own structure rather than the 14-section node-spec depth standard (Control_Spec §8.3, post-v6 amendment).
**Last updated:** 2026-05-13 (v2: Garmin reframed — not live, build from scratch; new athlete-integration-data retention rule; per L3-Spec-Trio feedback round 2)
**Supersedes:** `Athlete_Data_Integration_Spec.md` (v1, 2026-05-13)
**Source decisions:**
