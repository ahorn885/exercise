...
**Status:** File-revision v2 — 2026-05-12 (post-FC-2). First draft 2026-05-10; v1 closed 2026-05-11.
...
- `Layer0_ETL_Spec_v3_Patch_Batch_B.md`, `Layer0_ETL_Spec_v3_Patch_Batch_C.md`, `Layer0_ETL_Spec_v3_Patch_Batch_D.md`, `Layer0_ETL_Spec_v3_Patch_Batch_B_Correction.md` (incremental patches)
...
### Layer 0
- ✅ `Layer0_ETL_Spec_v4` — canonical (shipped FC-2 2026-05-12; folds Batch B/B-Correction/D-v1/D-v2 patches + drift report items; schema version still v3, file revision v4)
- 🟢 `Layer0_ETL_Spec_v3` — historical predecessor
- ✅ `Layer0_Deployed_Schema_and_Drift_Report` — current truth (still consulted; pairs with v4)
- ✅ Batch B, B-Correction, D-v1, D-v2 patches — folded into v4
- 🟢 Batch A and Batch C patches — referenced in v1's doc map and Batch D v2 companion-docs line, but absent from project knowledge at FC-2 draft. Reconstructed from drift report. Tracked as D-43 in Project_Backlog (archive-if-recovered, no spec change expected).
- 🟢 `Vocabulary_Audit_v3` (referenced as 0C source by v4) — Collarbone added, total 51 (D-39, FC-2)
...
### Cross-cutting
- ✅ `Control_Spec_v2` — this doc (file-revision v2, 2026-05-12)
- ✅ `Project_Backlog_v6` — rolling tracker (file-revision v6, 2026-05-12; FC-2 closures + new cleanup items D-40 through D-43)
