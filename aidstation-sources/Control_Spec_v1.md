...
**Status:** First draft, 2026-05-10. File-revision v1 — 2026-05-11.
...
### Layer 0
- ✅ `Layer0_ETL_Spec_v3` — canonical (needs v4 rewrite per drift report; v3 is the schema-version, not a file-revision)
- ✅ `Layer0_Deployed_Schema_and_Drift_Report` — current truth
- ✅ Batch A, B, C, D patches + Batch B Correction — incremental
- ⏳ `Layer0_ETL_Spec_v4` — pending FC-2
...
- ✅ `Layer2D_Spec` — drafted 2026-05-10
...
### Cross-cutting
- ✅ `Control_Spec` — this doc (file-revision v1, 2026-05-11)
- ✅ `Project_Backlog` — rolling tracker (file-revision v1, 2026-05-11)
