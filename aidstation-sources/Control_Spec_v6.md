...
**Status:** File-revision v6 — 2026-05-13 (post-L3-Spec-Trio). v5 closed 2026-05-13 (FC-4b); v4 closed 2026-05-13 (FC-4a); v3 closed 2026-05-13 (FC-3); v2 closed 2026-05-12; v1 closed 2026-05-11.
...
### Layer 1
- ✅ `Athlete_Onboarding_Data_Spec_v3` — canonical (v3, 2026-05-13; §H.3 Non-Event Goal Type field added per L3-Discovery)
...
### Layer 3+
- ⏳ `Layer3_Spec` — not yet started (4-node structure: 3A LLM state eval / 3B LLM goal-timeline viability / 3C rules conflict detection / 3D query HITL gate, per L3-Discovery handoff)
- ⏳ `Layer4_Spec` — not yet started (plan generation)
- ⏳ `Layer5_Spec` — not yet started (supplemental outputs)

### Cross-cutting
- ✅ `Control_Spec_v6` — this doc (file-revision v6, 2026-05-13)
...
- ✅ `Athlete_Data_Integration_Spec` — v1 shipped 2026-05-13 (L3-Spec-Trio); consumer-side spec for AIDSTATION pipeline access to integration data; locks integration architecture (single Neon DB, two schemas, Layer 1 as conceptual aggregation, Garmin onto `provider_auth`, PG-only)
- ✅ `Catalog_Migration_Plan` — v1 shipped 2026-05-13 (L3-Spec-Trio); strategy for app catalog migration from `public.*` to `layer0.*` (Option A, D-52)
- ✅ `Project_Backlog_v10` — rolling tracker (file-revision v10, 2026-05-13; L3-Discovery + L3-Spec-Trio session blocks; D-48 through D-56 added)
