...
| 2B-3 | `§H.2 Race Terrain Type` field must use TRN-xxx IDs as controlled vocabulary | Layer 1 onboarding spec | Open Item E from 2B locking; blocks 2B runtime not design |
