...
**Status:** File-revision v3 — 2026-05-13 (post-FC-3). v2 closed 2026-05-12; v1 closed 2026-05-11.
...
**Spec docs:**
- `Layer0_ETL_Spec_v5.md` (the canonical doc; FC-3, 2026-05-13; folds v4 consolidation + FC-3 schema corrections + §5 query-layer rewrite)
...
### Layer 0
- ✅ `Layer0_ETL_Spec_v5` — canonical (shipped FC-3 2026-05-13; FC-3 Neon-verified schema corrections to §4.8/§4.16/§4.17 + §5 query-layer narrative rewrite mirroring per-layer signatures; schema version still v3, file revision v5)
- 🟢 `Layer0_ETL_Spec_v4` — historical predecessor (FC-2 consolidation; superseded by v5)
- 🟢 `Layer0_ETL_Spec_v3` — historical predecessor
- ✅ `Layer0_Deployed_Schema_and_Drift_Report` — current truth (still consulted; pairs with v5)
- ✅ Batch B, B-Correction, D-v1, D-v2 patches — folded into v4 / carried in v5
...
- 🟢 `Vocabulary_Audit_v3` (referenced as 0C source by v5) — Collarbone added, total 51 (D-39, FC-2)
...
### Cross-cutting
- ✅ `Control_Spec_v3` — this doc (file-revision v3, 2026-05-13)
- 🟢 `Control_Spec_v2` — historical predecessor
- ✅ `Project_Backlog_v7` — rolling tracker (file-revision v7, 2026-05-13; FC-3 closures D-40/D-42/D-44/D-45 + new items D-46 follow-up; D-41 carried with retry)
