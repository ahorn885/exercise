...
\echo '--     D-006 XC Cycling (Road/Gravel) | INCLUDED | Primary'
\echo '--     D-008 Mountain Biking | INCLUDED | Primary'
\echo '--     D-009 Packrafting | INCLUDED | Primary'
\echo '--     D-010 Flat-water Kayaking | INCLUDED | Primary'
\echo '--     D-010 Whitewater Kayaking | INCLUDED | Minor (*Conditional)'
\echo '--     D-011 Canoeing | INCLUDED | Primary (race-dependent)'
\echo '--     D-012 Rock Climbing | INCLUDED | Secondary'
\echo '--     D-013 Abseiling | INCLUDED | Minor'
\echo '--     D-014 Fixed Rope / Via Ferrata | INCLUDED | Minor'
\echo '--     D-015 Orienteering/Nav (Cross-discipline) | INCLUDED | Primary'
\echo '--     D-016 Swimming | INCLUDED | Minor'
\echo '--     D-017 Snowshoeing | INCLUDED | Minor'
\echo '--     D-018 Mountaineering | INCLUDED | Minor'
\echo ''
\echo '-- Deployed side:'
